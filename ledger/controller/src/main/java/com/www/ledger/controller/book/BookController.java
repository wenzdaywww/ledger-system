...
public class BookController {
     ...
     */
    @GetMapping("day")
    public Response<List<BookDayResponse>> findLast10DaySales(){
        Response<List<List<OrderDTO>>> dtoResponse = bookService.findLast10DaySales(JwtAuthorizationTokenFilter.getUserId());
