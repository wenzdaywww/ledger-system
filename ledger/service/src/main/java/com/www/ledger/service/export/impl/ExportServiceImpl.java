...
public class ExportServiceImpl implements IExportService {
     ...
     */
    @Override
    public Long createDocumentData(String userId, List<Integer>sheetList){
        //查询用户正在生成的报表文件
        ...
        if(docEntity == null){
            ...
            docEntity.setUserId(userId).setOverdueTime(DateUtils.stepHour(DateUtils.getCurrentDateTime(),24))
                    .setDocName(userId + CharConstant.MINUS_SIGN + "export-" + DateUtils.format(DateUtils.getCurrentDateTime(), DateFormatEnum.YYYYMMDDHHMMSSSSS))
